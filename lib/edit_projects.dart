...
class EditProject extends StatefulWidget {
  ...
  final pid;
  final document_id;
  EditProject({Key key, this.pname, this.pdescription, this.pid, this.document_id})
      : super(key: key);
  // This widget is the root of your application.
  @override
  _EditProjectState createState() => new _EditProjectState(
      pname: pname, pdescription: pdescription, pid: pid, document_id: document_id);
}
...
class _EditProjectState extends State<EditProject> {
  ...
  final pid;
  final document_id;
  _EditProjectState({Key key, this.pname, this.pdescription, this.pid, this.document_id});
  ...
  _updateData() async {
    await Firestore.instance
      ...
      'project_description':project_descriptionController.text
  ...
  @override
  void initState() {
    project_descriptionController.text = pdescription;
    project_nameController.text = pname;
    //docId = document_id;
    this.uid = '';
